...
const createLocation = async (req, res) => {
  const { locationId, locationName, locationLatitude, locationLongitude } = req.body
  const newLocation = await db.Location.create({ // should send only primary key and secondary key??or send only primary key
